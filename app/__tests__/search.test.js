...
const items = [
  ...
  { id: 'b', title: '京都旅行', category: 'go', memo: '紅葉の時期に行きたい', withWho: 'friend' },
  { id: 'c', title: '観たい映画', category: 'see', withWho: null },
